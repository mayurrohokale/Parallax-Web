...
export default function Home() {
  return (
    <div>
      ...
      <Parallax strength={600} bgImage={earth2} bgStyle={10}>
        <div className="content">
          <div className="text-button">Explore Space!</div>
          <div className="bg-white p-8">
            <h1 className="text-center pb-6 font-bold ">FIRST CLASS TICKET</h1>
            <h3>
